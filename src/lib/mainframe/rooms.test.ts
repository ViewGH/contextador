...
test("buildBroadcast creates correct structure", () => {
  const msg = buildBroadcast({ query: "auth flow", queryHash: "a3f2c1", scopes: ["services/gateway"], pointers: { purpose: "handles requests" }, tokensUsed: 480, agentId: "ctx-a7f3", contextValidated: "abc1234" });
